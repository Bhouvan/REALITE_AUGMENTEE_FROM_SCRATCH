...
(*this)(3,3)*v.w 
    ...
    inline Mat4d RotateAxis(const Vec3d& axis, double angleRad) { 
...
// Vérification : 
// RotateAxis({0,1,0}, PI/2) × {1,0,0,1} = {0,0,-1,1} (rotation de X vers -Z)
...
// Construire Mat4d depuis [R3×3 | t3×1] de solvePnP (Semestre 3) 
...
// 3. Translater vers la position monde 
    inline Mat4d TRS(const Vec3d& t, const Vec3d& axis, double angle, const Vec3d& s) { 
