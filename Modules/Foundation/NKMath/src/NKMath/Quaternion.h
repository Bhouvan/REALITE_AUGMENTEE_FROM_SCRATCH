...
struct Quat { 
    double w, x, y, z;  // w = partie réelle, (x,y,z) = partie imaginaire 
 
    Quat() : w(1.0), x(0.0), y(0.0), z(0.0) {}  // identité = pas de rotation 
...
inline Vec3d Rotate(const Quat& q, const Vec3d& v) { 
    ...
    inline bool Compare(const Quat& a, const Quat& b)
    {
    return (approxEq(a.w,b.w,1e-6) && approxEq(a.x,b.x,1e-6) && approxEq(a.y,b.y,1e-6) && approxEq(a.z,b.z,1e-6))?true:false;
    } 
} // namespace NkMath 
